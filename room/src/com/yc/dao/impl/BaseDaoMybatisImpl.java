...
public class BaseDaoMybatisImpl<T> extends SqlSessionDaoSupport implements BaseDao<T> {
	...
	public double getFunc(Class<T> clazz, String sqlId) {
		return super.getSqlSession().selectOne(clazz.getSimpleName()+ "Mapper." + sqlId );
	}

	@Override
	public double getFunc(T t, String sqlId) {
		return super.getSqlSession().selectOne(t.getClass().getSimpleName()+ "Mapper." + sqlId ,t);
	}

	@Override
	public double getFunc(Class<T> clazz, String sqlId, Map<String, Object> parameterMap) {
		return super.getSqlSession().selectOne(clazz.getClass().getSimpleName()+ "Mapper." + sqlId ,parameterMap);
	}
